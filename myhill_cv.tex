...
\firstname{Robert}
\familyname{Myhill}
\title{Postdoctoral Research Associate}      % optional, remove the line if not wanted
...
\section{Employment}
\cventry{2015}{Postdoctoral Research Associate}{School of Earth Sciences}{University of Bristol}{}{Project: Preparation for the InSight Mission to Mars}
...
\cvitem{2016}{Myhill, R., Teanby, N. and Wookey, J., Seismic diagnostics for the interior chemistry of Mars: guides for the InSight Mission, in prep.}
\cvitem{2016}{Myhill, R., Rubie, D. and Frost, D. J., Partitioning between silicate and metal melts; a model for core formation, in prep.}
\cvitem{2016}{Dannberg, J. et al., Grain-size dependent convection and seismic observables in the Earth's mantle, in prep.}
\cvitem{2016}{Myhill, R. et al., Quenchable water-rich aluminous post-stishovite, and implications for water cycling and seismic scatterers in the lower mantle, American Mineralogist, in prep.}
\subsection{Submitted and accepted}
\cvitem{2016}{Panero, W. et al., Water in the mantle transition zone, submitted to Science.}
\cvitem{2016}{Novella, D. et al., Melting phase relations in the systems Mg$_2$SiO$_4$-H$_2$O and MgSiO$_3$-H$_2$O at upper mantle conditions, submitted to Geochimica et Cosmochimica Acta.}
\cvitem{2016}{Rassios, A. et al., Preserving the non-preservable geoheritage of the Aliakmon River: A case study in geo-education leading to cutting-edge science, submitted to Bulletin of the Geological Society of Greece.}
\cvitem{2016}{Myhill, R., Excess thermodynamic and elastic properties of mineral and melt solutions: modelling and implications for phase relations and seismic velocities, submitted to Contributions to Mineralogy and Petrology.}
\cvitem{2016}{Myhill, R. et al. Hydrous melting and partitioning in and above the mantle transition zone: insights from water-rich MgO-SiO$_2$-H$_2$O experiments, accepted, Geochimica et Cosmochimica Acta.}
\cvitem{2016}{Myhill, R. et al., On the P-T-\emph{f}O$_2$ stability of Fe$_4$O$_5$ and Fe$_5$O$_6$-rich phases: a thermodynamic and experimental study, accepted, Contributions to Mineralogy and Petrology.}
